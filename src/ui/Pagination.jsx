...
function Pagination({ count }) {
  ...
  const currPage = !searchParams.get("page") ? 1 : +searchParams.get("page");
  ...
  return (
    <StyledPagination>
      ...
      <Buttons>
        <PaginationButton onClick={prvPage} disabled={currPage === 1}>
          <HiChevronLeft />
          <span>Previous</span>
        </PaginationButton>
        <PaginationButton disabled={currPage === pageCount} onClick={nextPage}>
          <span>Next</span>
          <HiChevronRight />
        </PaginationButton>
      </Buttons>
